...
void Map::FullSetMap()
{
    for (int i = 0; i < 10; i++) // ввод кораблей
    {
        ...
        if (i == 0) {
            ...
            {
                s = 4;
                cout << "Ведите координаты и ориентацию 4 корабля" << endl;
                cout << "x: ";
                cin >> x;
                cout << "y: ";
                cin >> y;
        ...
        if (i > 0 and i < 3) {
            ...
            {
                s = 3;
                cout << "Ведите координаты и ориентацию 3 корабля" << endl;
                cout << "x: ";
                cin >> x;
                cout << "y: ";
                cin >> y;
        ...
        if (i > 2 and i < 6) {
            ...
            {
                s = 2;
                cout << "Ведите координаты и ориентацию 2 корабля" << endl;
                cout << "x: ";
                cin >> x;
                cout << "y: ";
                cin >> y;
        ...
        if (i > 5) {
            ...
            {
                s = 1;
                cout << "Ведите координаты и ориентацию 1 корабля" << endl;
                cout << "x: ";
                cin >> x;
                cout << "y: ";
                cin >> y;
